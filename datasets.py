    ...
    if args.dataset in ['cora', 'citeseer', 'pubmed']:
       ...
       # Data(edge_index=[2, 163788], x=[18333, 6805], y=[18333])
        ...
        dataset = get_coauthor_dataset(args.dataset, args.normalize_features)
          # Data(edge_index=[2, 163788], x=[18333, 6805], y=[18333])
    elif args.dataset in ['texas', 'cornell', 'wisconsin', 'chameleon', 'squirrel', 'film']:
        dataset = WebKB(root=path, name=name, transform=T.NormalizeFeatures())
    # elif args.dataset in ['ogbn-arxiv', 'ogbn-proteins', 'ogbn-proteinfunc']:  # 'ogbn-products',, 'ogbn-mag'
