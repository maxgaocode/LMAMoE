...
def get_planetoid_dataset(path, name, normalize_features=False, transform=None):
...
def get_coauthor_dataset(path, name, normalize_features=False, transform=None):
    #path = osp.join(osp.dirname(osp.realpath(__file__)), '../', 'datacon', name)
...
def get_amazon_dataset(path, name, normalize_features=False, transform=None):
    #path = osp.join(osp.dirname(osp.realpath(__file__)), '../', 'datacon', name)
...
def get_dataset(path, name):
    assert name in ['DBLP', 'Karate', 'WikiCS', 'Coauthor-CS', 'Coauthor-Phy',
    ...
    #     return get_planetoid_dataset(name, normalize_features=False, transform=None)
